...
export default function TokensAdminPage() {
  ...
  return (
    <div className="p-6 space-y-6 max-w-6xl">
      <div>
        <h1 className="admin-page-title text-zinc-900 dark:text-zinc-100">Tokens</h1>
      ...
      <section className="rounded-xl border border-zinc-200 bg-white p-4 dark:border-zinc-800 dark:bg-zinc-900/40">
        ...
        <div className="mt-4 flex flex-wrap items-end gap-3">
          ...
          <label className="flex min-w-[200px] flex-1 flex-col gap-2 admin-field-label text-zinc-600 dark:text-zinc-400">
